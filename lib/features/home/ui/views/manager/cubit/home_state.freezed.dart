...
mixin _$HomeState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(AllspecializationResponseModel data) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(AllspecializationResponseModel data)? success,
...
abstract class _$$SuccessImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({AllspecializationResponseModel data});
}
    ...
    return _then(_$SuccessImpl<T>(
      null == data
          ...
          : data // ignore: cast_nullable_to_non_nullable
              as AllspecializationResponseModel,
    ));
  }
}
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  final AllspecializationResponseModel data;
...
abstract class Success<T> implements HomeState<T> {
  const factory Success(final AllspecializationResponseModel data) =
      _$SuccessImpl<T>;

  AllspecializationResponseModel get data;
  @JsonKey(ignore: true)
  _$$SuccessImplCopyWith<T, _$SuccessImpl<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
